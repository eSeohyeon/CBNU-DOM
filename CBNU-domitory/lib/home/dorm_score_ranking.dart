...
class _DormScoreRankingState extends State<DormScoreRanking> {
  ...
  void initState() {
    ...
    _allUsers.add(User(profilePath: 'assets/profile_business.png', name: '두부두부두루치기', department: '전정대', yearEnrolled: '25학번', isSmoking: false, checklist: [], dormScore: 95));
    for(int i=0; i<20; i++){
      _allUsers.add(User(profilePath: 'assets/profile_business.png', name: '두부두부두루치기', department: '전정대', yearEnrolled: '25학번', isSmoking: false, checklist: [], dormScore: 95));
    }
  ...
  Future<void> _loadMoreData() async {
    ...
    final List<User> newItems = [
      User(profilePath: 'assets/profile_pharmacy.png', name: '두부두부두루치기', department: '전정대', yearEnrolled: '25학번', isSmoking: false, checklist: [], dormScore: 9),
      User(profilePath: 'assets/profile_pharmacy.png', name: '두부두부두루치기', department: '전정대', yearEnrolled: '25학번', isSmoking: false, checklist: [], dormScore: 9),
      User(profilePath: 'assets/profile_pharmacy.png', name: '두부두부두루치기', department: '전정대', yearEnrolled: '25학번', isSmoking: false, checklist: [], dormScore: 9),
      User(profilePath: 'assets/profile_pharmacy.png', name: '두부두부두루치기', department: '전정대', yearEnrolled: '25학번', isSmoking: false, checklist: [], dormScore: 9),
      User(profilePath: 'assets/profile_pharmacy.png', name: '두부두부두루치기', department: '전정대', yearEnrolled: '25학번', isSmoking: false, checklist: [], dormScore: 9),
        ...
        child: Column(
          children: [
            Column(
              children: [
                CircleAvatar(
                  child: Image.asset('assets/profile_computer.png'),
                  radius: 44.0
                ),
