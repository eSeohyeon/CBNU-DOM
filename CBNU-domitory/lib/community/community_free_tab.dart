...
import 'package:untitled/community/free_detail_page.dart';
...
class _FreePostTabState extends State<FreePostTab> {
  ...
  final Post _post2 = Post(postId: 123, title: '취업 꿀팁', writer: '서울사이버대학', date: '05/09', time: '03:34', contents: '서울사이버대학에 다니고 나의 성공시대 시작됐다.');
          ...
          Container(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index){
                ...
                return InkWell(child: FreePostListItem(post: post), onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => FreePostDetailPage(post: post)));
                });
              },
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
          ...
          children: [
            Text(post.title, style: boldBlack16, maxLines: 1, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, softWrap: false),
